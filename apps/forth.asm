...
INTERPRET_LOOP:
		HEADER "INTL", INTERPRET_LOOP, COMPOSITE_HEADER
		dd INTERPRET, RESETPC, EXIT

RESETPC:
		HEADER "RSTP", RESETPC
		sub PC, 8 ; -4 to step out of PC, -4 to go back to previous word
		jmp NEXT

QUIT:
		HEADER "QUIT", QUIT, COMPOSITE_HEADER
		dd INTERPRET_LOOP, EXIT
